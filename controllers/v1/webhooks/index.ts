...
console.log(body);
        ...
        let startDate = (body.line_items[0].properties) ? body.line_items[0].properties[0].value : "Not Found";
        let endDate = (body.line_items[0].properties) ? body.line_items[0].properties[0].value : "Not Found";
