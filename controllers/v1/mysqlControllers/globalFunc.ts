...
// /new func for custom query

const findRecordsWithCustomQuery = async (query: string) => {
  return new Promise((resolve, reject) => {
...
export { findRecordsGlobal, findRecordsLastXMinutes,findRecordsWithCustomQuery };
